...
class TrainBP:
    ...
    def train(self, train_path, val_path, test_path, target, verbose=False):
        ...
        preds_test_original, y_test_original = self.inverse_target(
            preds_test, y_test_scaled
        )
        ...
        return (
            ...
            preds_test_original.flatten(),
            test_error,
        )

    def loss_epochs(self) -> pd.DataFrame:
        ...
        if self.nn is not None:
            ...
            raise ValueError("Neural network has not been trained yet.")
